    ...
    def admin_lisans_onayla(lid):
        ...
        if kullanici and prog:
            ...
            mailer.send_mail(
                ...
                f"<h4 style='margin-top:18px;'>📦 Lisans &amp; Erişim Bilgileri</h4>"
                f"<table style='border-collapse:collapse;margin-bottom:14px;'>"
                f"<tr><td style='padding:6px 12px;border:1px solid #ddd;background:#f8fafc;'><b>Lisans Anahtarı</b></td>"
                f"<td style='padding:6px 12px;border:1px solid #ddd;font-family:monospace;'>{lisans.anahtar}</td></tr>"
                f"<tr><td style='padding:6px 12px;border:1px solid #ddd;background:#f8fafc;'><b>ZIP Parolası</b></td>"
                f"<td style='padding:6px 12px;border:1px solid #ddd;font-family:monospace;'>{lisans.zip_parolasi}</td></tr>"
                f"<tr><td style='padding:6px 12px;border:1px solid #ddd;background:#f8fafc;'><b>Geçerlilik</b></td>"
                f"<td style='padding:6px 12px;border:1px solid #ddd;'>1 yıl</td></tr>"
                f"</table>"
                f"<h4 style='margin-top:18px;'>📥 Adım Adım Kurulum</h4>"
                f"<ol style='line-height:1.7'>"
                f"<li>Siteye giriş yapıp aşağıdaki <b>Programı İndir</b> butonuna basın; "
                f"<code>VI_RAPOR_v1.1_LISANSLI.zip</code> bilgisayarınıza iner.</li>"
                f"<li><b style='color:#b91c1c;'>⚠ Önemli:</b> ZIP, <b>AES-256</b> ile şifrelidir; Windows'un "
                f"yerleşik ZIP desteği bunu açamaz. Önce ücretsiz <b>7-Zip</b> kurun: "
                f"<a href='https://www.7-zip.org/download.html'>https://www.7-zip.org/download.html</a></li>"
                f"<li>ZIP'e sağ tık → <b>7-Zip → Buraya çıkar</b>. Açılan kutuya yukarıdaki "
                f"<b>ZIP Parolası</b>'nı yapıştırın.</li>"
                f"<li>Çıkan klasörde önce <b>KURULUM.bat</b>'a çift tıklayın (Python paketlerini yükler).</li>"
                f"<li>Sonra kullanmak istediğiniz modu seçin: "
                f"<b>BASLAT_WEB.bat</b> (tarayıcıdan) veya <b>BASLAT_MASAUSTU.bat</b> (tkinter).</li>"
                f"<li>Program ilk açılışta sizden <b>Lisans Anahtarı</b>'nızı isteyecek; yapıştırıp "
                f"onaylayın. 1 yıl boyunca her açılışta online doğrulama yapar.</li>"
                f"</ol>"
                f"<p style='margin-top:18px;'>"
                f"<a href='{indir_link}' style='background:#d9a521;color:#0b1f44;padding:12px 26px;"
                f"text-decoration:none;border-radius:8px;font-weight:700;display:inline-block;'>"
                f"⬇ Programı İndir</a></p>"
                ...
                f"<p style='font-size:12px;color:#666;'>"
                f"Sorularınız için: info@vergiindirim.com.tr · 0532 177 47 95</p>"
            )
        flash(
